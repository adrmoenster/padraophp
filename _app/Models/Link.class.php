...
class Link {
    ...
    public function __construct() {
        ...
        $this->Categoria = (isset($this->Local[1]) ? $this->Local[1] : HOME);
        $this->Link = (isset($this->Local[2]) ? $this->Local[2] : HOME);
    }

    public function getTags() {
        $this->Tags = new Seo($this->File, $this->Categoria, $this->Link);
        $this->Tags = $this->Tags->getTags();
        echo $this->Tags;
    }

    public function getDados() {
        $this->Dados = new Seo($this->File, $this->Categoria, $this->Link);
    ...
    private function setPatch() {
        ...
        elseif (file_exists(REQUIRE_PATH . DIRECTORY_SEPARATOR . $this->File . DIRECTORY_SEPARATOR . $this->Categoria . DIRECTORY_SEPARATOR .$this->Link . '.php')):
            $this->Patch = REQUIRE_PATH . DIRECTORY_SEPARATOR . $this->File . DIRECTORY_SEPARATOR . $this->Categoria . DIRECTORY_SEPARATOR . $this->Link . '.php';
        else:
